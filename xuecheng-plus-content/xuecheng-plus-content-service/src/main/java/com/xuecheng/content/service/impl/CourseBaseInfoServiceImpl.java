...
//        courseBaseNew.setDescription(dto.getDescription());
    ...
    public CourseBaseInfoDto getCourseBaseById(Long courseId) {
        ...
        lambdaQueryWrapper.eq(CourseCategory::getId, courseBase.getMt()).or().eq(CourseCategory::getId, courseBase.getSt());
        List<CourseCategory> courseCategories = courseCategoryMapper.selectList(lambdaQueryWrapper);
        courseBaseInfoDto.setMtName(courseCategories.get(0).getName());
        courseBaseInfoDto.setStName(courseCategories.get(1).getName());
    ...
    public CourseBaseInfoDto updateCourseBase(Long companyId, EditCourseDto editCourseDto) {
        ...
        if (!companyId.equals(courseBase.getCompanyId())) {
            XueChengPlusException.cast("本机构只能修改本机构的Id");
        }
